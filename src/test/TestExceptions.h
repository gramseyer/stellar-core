...
TEST_EXCEPTION(ex_CREATE_SPEEDEX_IOC_OFFER_NO_SPEEDEX_CONFIG)
TEST_EXCEPTION(ex_CREATE_SPEEDEX_IOC_OFFER_INVALID_TRADING_PAIR)
TEST_EXCEPTION(ex_CREATE_SPEEDEX_IOC_OFFER_INSUFFICIENT_BALANCE)
TEST_EXCEPTION(ex_CREATE_SPEEDEX_IOC_OFFER_MALFORMED)
